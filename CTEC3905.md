...
<figure>
	<img src="images/timbl.png" alt="Tim Berners-Lee" style="height: 500px;">
...
<figure>
	<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ed/W3C%C2%AE_Icon.svg/440px-W3C%C2%AE_Icon.svg.png" alt="W3C logo" style="height: 500px;">
...
We have four timetabled hours per week.

- *Lecture (1hr): Tuesday @ 13:00* - introduce the core concepts.
- *Lecture (1hr): Thursday @ 12:00* - Q&A, code demonstrations, lab solutions, supplementary material.
- *Lab (2hr): (see timetable)* - Practice and build your experience with the technologies.

<hr>

It is *essential* to attend all sessions and attempt the lab exercises *prior to your timetabled session*. 

**You must view/read the provided content and attempt the exercise before your timetabled lab each week.**

Come to the lectures and labs with your questions.
If you don't have questions, we will give you some.

> *Practice is critical - this is a practical, coding module.*
...
| 29   |  5 Feb | Mobile-first, responsive web design.                  |
...
- **Module information:** module handbook, similar to this presentation, includes module calendar

<hr>
- **Learning materials:** primary learning resources
	- links to download and install VSCode, Google Chrome and Git.
	- Link to github resources - code examples, lecture slides, lab exercises.
	- Week-by-week materials - pre-recorded videos, links to slides, lab exercises.
...
- **Assessment:**
	- Assignment brief
	- Marking scheme
	- github invitation and submission link (eventually) 
...
- **Deadline:** Friday 26th April 2024 (week 29) @ 12:00 (midday)
- **Feedback:** Tuesday 28th May 2024 (week 35) by 12:00 (midday)
...
A private **repository will be created for you** within the [CTEC3905 github organisation](https://github.com/ctec3905-2022).
...
The full marking criteria are listed under **Assessment** on Blackboard.
...
<figure>
	...
	<figcaption>Google Chrome is used for 63.42% of global traffic (Q4 2023).</figcaption>
</figure>
...
<figure>
	...
	<figcaption>
		The <a href="https://code.visualstudio.com/">VSCode</a> editor is recommended for this module.
	</figcaption>
</figure>

If you have a compelling reason (e.g. expertise) to use a different editor then that's OK.
Though using a modern editor is essential and VSCode can be used for many different languages.

<div class="reference">
	<a href="https://commons.wikimedia.org/wiki/File:Visual_Studio_Code_1.35_icon.svg">Microsoft, Public domain, via Wikimedia Commons</a>
</div>
...
We will also demonstrate git use **from within VSCode**.
