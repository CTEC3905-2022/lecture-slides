...
We have three timetabled hours per week.

- *Lecture: Wednesday @ 10:00* - introduce the core concepts.
- *Lecture: Thursday @ 11:00* - Q&A, code demonstrations, lab solutions, supplementary material.
- *Lab: (see timetable)* - Practice and build your experience with the technologies.

It is *essential* to attend both sessions and complete the lab exercises *in your time* prior to the lab session.
*Practice is critical - this is a practical, coding module.*

The *asynchronous resources* provide essential technical information and carefully-selected links for further information and wider perspectives on front-end web technologies.
You need to consume these resources *outside of timetabled sessions* and come to the lectures and labs with your questions.
